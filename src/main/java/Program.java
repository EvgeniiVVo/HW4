...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Fruit> fruits = Fabric.generateFruits(10);
        ...
        Box<Apple> boxApples = new Box<Apple>(Fabric.getApples(fruits));
        System.out.println(boxApples);
        System.out.println();

        System.out.println("========================== Коробка с апельсинами ==============================");
        Box<Orange> boxOrange = new Box<Orange>(Fabric.getOranges(fruits));
        ...
        Box<Apple> boxApples1 = new Box<Apple>(Fabric.generateApples(10));
        System.out.println(boxApples1);
        System.out.println();

        System.out.println("========================== Привезенная коробка с апельсинами в магазин ==============================");
        Box<Orange> boxOrange1 = new Box<Orange>(Fabric.generateOranges(10));
        System.out.println(boxOrange1);
        System.out.println();

        System.out.println("========================== Перекладываем все яблоки в магазинную коробку ==============================");
        Box<Apple> boxApples2 = new Box<Apple>(boxApples1.getFruits());
        System.out.println("Информация о привезенной коробке:" + boxApples1);
        System.out.println("Информация о получившейся магазинной коробке:" + boxApples2);
        ...
        System.out.println("Информация о привезенной коробке:" + boxOrange1);
        System.out.println("Информация о получившейся магазинной коробке:" + boxOrange2);
